# -*- coding: utf-8 -*-
"""Copy of Transformers can do anything

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1lnThR5K8cDzQvYKSyB_OhksoCHWUdYGl
...
!pip install -U -q huggingface_hub diffusers accelerate datasets torch soundfile sentencepiece opencv-python openai
...
# HF Token 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
import getpass
...
audio = agent.run("Please read out loud follwing text", text=caption)
play_audio(audio)
...
agent.chat("Show me an an image of a cat")
